...
public class BotonJugar extends Button {
    ...
    public BotonJugar(VboxBotonesSeleccionados vb2, PersonajeView vistaPersonaje, Tablero unTablero){
        this.setText("Ejecutar");
        this.setLayoutX(118.0);
        this.setLayoutY(555.0);
        this.prefHeight(25.0);
        this.prefWidth(61.0);
        this.setOnAction(new HandlerBotonJugar(vb2,vistaPersonaje, unTablero));
